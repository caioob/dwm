...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD(TERMINAL " bluetoothctl") },
	...
	//{ 0,				XK_F12,		spawn,		{.v = (const char*[]){ "dmenurecord", "kill", NULL } } },
	{ 0,				XK_F12,		spawn,		SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png") },
